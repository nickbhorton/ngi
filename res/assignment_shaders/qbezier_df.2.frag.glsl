...
void main() {
    ...
    fColor = vec4(
        vec3(step(radius, min_dist)),
        1.0
    );

    float P0_circ = 1.0 - step(0.01, distance(P, P0) - radius);
    float P1_circ = 1.0 - step(0.01, distance(P, P1) - radius);
    float P2_circ = 1.0 - step(0.01, distance(P, P2) - radius);
